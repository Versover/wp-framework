 ...
 * 
 * Plugin Name: Versover_Widget_Business_Hours
 * Plugin URI: https://versover.com
 * Description: A widget that displays business hours.
 * Version: 1.0
 * Author: Evgeniy Mironov
 * Author URI: https://versover.com
*/

class Versover_Widget_Business_Hours extends WP_Widget {
	...
	public function __construct() {
		parent::__construct( 
			...
			__( 'Versover: Business Hours', 'versover' ),
			array(
				'classname'   => 'widget-business-hours',
				'description' => __( 'A custom widget that displays business hours.', 'versover' )
			) 
		);
	}
	...
	public function form( $instance ) {
		...
		<!-- Title -->
		<p>
			<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Title:', 'versover' ); ?></label>
			<input type="text" class="widefat" id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" value="<?php echo esc_attr( $instance['title'] ); ?>">
		</p>

		<!-- Description -->
		<p>
			<label for="<?php echo $this->get_field_id( 'hours_description' ); ?>"><?php _e( 'Description:', 'versover' ); ?></label>
		...
		<!-- Monday-Friday -->
		<p>
			<label for="<?php echo $this->get_field_id( 'hours_monday_friday' ); ?>"><?php _e( 'Monday-Friday:', 'versover' ); ?></label>
		...
		<!-- Saturday -->
		<p>
			<label for="<?php echo $this->get_field_id( 'hours_saturday' ); ?>"><?php _e( 'Saturday:', 'versover' ); ?></label>
		...
		<!-- Sunday -->
		<p>
			<label for="<?php echo $this->get_field_id( 'hours_sunday' ); ?>"><?php _e( 'Sunday:', 'versover' ); ?></label>
	...
	public function widget( $args, $instance ) {
		...
		if ( $hours_monday_friday ) : ?>
			<li>
				<span><?php _e( 'Monday-Friday: ', 'versover' ); ?></span>
		...
		if ( $hours_saturday ) : ?>
			<li>
				<span><?php _e( 'Saturday: ', 'versover' ); ?></span>
		...
		if ( $hours_sunday ) : ?>
			<li>
				<span><?php _e( 'Sunday: ', 'versover' ); ?></span>
...
add_action( 'widgets_init', create_function( '', 'register_widget( "Versover_Widget_Business_Hours" );' ) );
