...
$errorMessage   = __( 'Please enter the message.', 'versover' );
				...
				<div class="entry-content">
					...
					<form action="<?php the_permalink(); ?>" id="contact-form" method="POST" role="form">
						<div class="form-group <?php if ( isset( $errors['errorName'] ) ) echo "has-error"; ?>">
							<label for="contact-name" class="control-label"><span class="required">* </span><?php _e( 'Name:', 'versover' ); ?></label>
						...
						<div class="form-group <?php if ( isset( $errors['errorEmail'] ) ) echo "has-error"; ?>">
							<label for="contact-email" class="control-label"><span class="required">* </span><?php _e( 'Email Address:', 'versover' ); ?></label>
						...
						<div class="form-group <?php if ( isset( $errors['errorMessage'] ) ) echo "has-error"; ?>">
							<label for="contact-message" class="control-label"><span class="required">* </span><?php _e( 'Message:', 'versover' ); ?></label>
						...
						<button type="submit" class="btn btn-default"><?php _e( 'Send Message', 'versover' ); ?></button>
					</form>
